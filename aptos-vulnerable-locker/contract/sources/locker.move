/**
 * This example is taken from https://github.com/aptos-labs/aptos-core/blob/7cb6922aa94dc519a8d3ce92ca285ee063649a21/aptos-move/move-examples/defi/sources/locked_coins.move
 * and modified to incorrectly check for unlock time.
 **/
module locker::locked_coins {
    ...
    public entry fun claim<CoinType>(recipient: &signer, sponsor: address) acquires Locks {
        ...
        // Vulnerability is here: unlock_time_secs is not checked against now_secs
        assert!(!is_time_to_claim(unlock_time_secs, unlock_time_secs), error::invalid_state(ELOCKUP_HAS_NOT_EXPIRED));
    ...
    fun is_time_to_claim(now_time: u64, unlock_time: u64): bool {
        now_time > unlock_time
    }
